...
export const hideCardFrontToOthers: HidingStrategy = (item: MaterialItem, player?: PlayerId) => (item.location.player === player ? [] : ['id.front'])

export const hideCoinWhenNotRotated: HidingStrategy = (item: MaterialItem, player?: PlayerId) => {
