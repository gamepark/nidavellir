import { CardLocation, InAgeDeck, InArmy, InCommandZone, InHeroesDeck, InTavern } from '../state/LocatedCard';
import { LocationType } from '../state/Location';
import GameState from '../state/GameState';
import GameView from '../state/view/GameView';
import { CoinLocation, InTreasure } from '../state/LocatedCoin';
import { PlayerId } from '../state/Player';
import { InDiscard, InDistinctionDeck, InPlayerHand, OnPlayerBoard } from '../state/CommonLocations';
...
export const isInArmy = (location: CardLocation): location is InArmy =>
  location.type === LocationType.Army && location.player !== undefined;
