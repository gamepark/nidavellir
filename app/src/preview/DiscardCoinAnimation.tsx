...
type PutCoinInTreasureAnimationProps = {
  animation: Animation<MoveCoin>;
  game: GameView;
};

const DiscardCoinAnimation: FC<PutCoinInTreasureAnimationProps> = (props) => {
  ...
  return (
    <div css={animationStyle}>
      <div css={header}>
        <span>{t('player.animation.discard')}</span>
      </div>
      <div css={content}>
        <span css={arrow}>-</span>
